      ...
      <div className="w-full max-w-md rounded-2xl bg-white shadow-xl flex flex-col">
        ...
        <div className="flex justify-end gap-3 border-t border-gray-100 px-5 py-4">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={deleting}
            className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${isDeletedUser
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col gap-6 p-4 lg:p-6 overflow-hidden">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 flex-shrink-0">
        {STAT_CARDS.map((card) => (
          <div key={card.key} className="bg-white rounded-xl shadow-sm px-5 py-4 min-h-[112px]">
