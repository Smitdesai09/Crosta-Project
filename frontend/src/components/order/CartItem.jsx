  ...
  return (
    <div className="flex items-start justify-between py-3 border-b border-gray-100 last:border-0">
      <div className="flex-1 pr-4">
        ...
        <p className="text-xs text-gray-500 mt-0.5">{item.variant} • ₹{item.price}</p>
      </div>
      <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-lg overflow-hidden">
        ...
        <span className="px-2 text-sm font-semibold text-gray-900 min-w-[20px] text-center">{item.quantity}</span>
